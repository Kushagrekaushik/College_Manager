...
class report_student:
    def __init__(self,student_report_window):
        self.home=Toplevel(student_report_window)
        ...
        self.hlbl = Label(self.home, text="Student Details", font=('Clarendon BT', 40), background='#E9C5FF',
                          foreground='#550685', relief='groove', borderwidth=5)
        self.tablearea=Frame(self.home)
        self.table1=Treeview(self.tablearea,columns=['c1','c2','c3','c4','c5','c6','c7','c8','c9'],height=25)
        ...
        self.table1.column("#9",width=150,anchor='center')
